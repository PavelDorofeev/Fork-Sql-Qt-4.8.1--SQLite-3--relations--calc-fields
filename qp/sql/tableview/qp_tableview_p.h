...
class  LIB_PREFIX_QP QpTableViewPrivate : public QpAbstractItemViewPrivate
{
...
public:
    ...
    static const bool debug_draw_cell;
    ...
    //QHash< int , qp::db::CELL_STYLE> stls; //!!

    //QHash< QPair<int,int> , qp::db::CELL_STYLE> cell_styles; //!!


    void init( );

    void correct_Style( const qp::db::CELL_STYLE &stls, QStyleOptionViewItemV4 &opt ); //!
