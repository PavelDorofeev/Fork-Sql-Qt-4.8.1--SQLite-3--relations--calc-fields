...
class  QpHorHeaderView : public QpAbstractItemView
{
    Q_OBJECT
    ...
    explicit QpHorHeaderView(QpTableView *prnt );
    ...
    bool test_matrix_with_model( ) const;
    ...
    void resizeSection(int logical, int size);

    const qp::db::SECTIONS_TMPL get_matrix() const;
    // void set_matrix( const qp::Qp_SECTION_TMPL & matrix); only init_template
    qp::db::SECTION_D section_d_at_Num_x_line(int num_x, int line) const;

    int resizeByHeaderTextSize();
    bool resizeLinesHeights_ByHeaderTextSize(  );
    int get_NumX_Size_header_Size(int sectionNum) const;

    void clear_sections_template( );
    void clear_sections_custom_sizes( );
    ...
    bool get_section_style( int sectionNum, qp::db::CELL_STYLE &stl ) const;
    void set_section_style( int sectionNum , const qp::db::CELL_STYLE &stl);
    void print_section_styles( const QString & str ) const;

    //const bool get_cell_style( int line, int numX, qp::db::CELL_STYLE &stl ) const;//!!
    //void set_cell_style( int line, int numX , qp::db::CELL_STYLE &stl) ;//!!
    ...
    virtual const qp::db::SECTION_D get_cell_at_line_xNum( int line, int num_x ) const;

    const qp::db::CELL_NODES get_logicalIdex_nodes(int logicalIndex) const;
    ...
    void interactiveResizeSection_X(int xNum, int newWidth);
...
Q_SIGNALS:
    ...
    void sectionResized(int numX, int oldSize, int newSize);
...
protected Q_SLOTS:
    ...
    void moveSection(int from, int to, qp::db::SectionEdge whereTo);
    ...
    qp::db::SECTION indexAt(const QPoint &p) const;
