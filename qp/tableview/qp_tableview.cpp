...
const bool QpTableView::debug                   = appDef::dbg_on && false;
const bool QpTableView::debug_init              = appDef::dbg_on && false;
const bool QpTableView::debug_paint             = appDef::dbg_on && false;
const bool QpTableViewPrivate::debug_draw_cell  = appDef::dbg_on && false;
const bool QpTableView::debug_row_col_cnt_short = appDef::dbg_on && false;
const bool QpTableView::debug_row_col_cnt_full  = appDef::dbg_on && false;
const bool QpTableView::debug_geometry      = appDef::dbg_on &&false;
const bool QpTableView::debug_event         = appDef::dbg_on &&false;
const bool QpTableView::debug_paint_region  = appDef::dbg_on && false;
const bool QpTableView::debug_paint_border  = appDef::dbg_on && false;
const bool QpTableView::debug_resize        = appDef::dbg_on && false;
const bool QpTableView::debug_mdl_signals   = appDef::dbg_on && false;
const bool QpTableView::debug_selection     = appDef::dbg_on && false;
const bool QpTableView::debug_scroll        = appDef::dbg_on && false;

const bool QpTableViewPrivate::debug_mdl_signals    = appDef::dbg_on && false;
const bool QpTableViewPrivate::debug                = appDef::dbg_on && false;
const bool QpTableViewPrivate::debug_selection      = appDef::dbg_on && false;
const bool QpTableViewPrivate::debug_init           = appDef::dbg_on && false;
...
qp::db::SECTION QpTableView::indexAt(const QPoint &pos) const
{
    Q_D(const QpTableView);
