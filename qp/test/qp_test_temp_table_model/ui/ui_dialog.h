...
**
** Created: Tue 1. Jul 11:48:21 2025
...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        btn_save_temp_mdl = new QPushButton(groupBox);
        btn_save_temp_mdl->setObjectName(QString::fromUtf8("btn_save_temp_mdl"));
        btn_save_temp_mdl->setAutoDefault(false);

        horizontalLayout_5->addWidget(btn_save_temp_mdl);
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        btn_save_temp_mdl->setText(QApplication::translate("Dialog", "SAVE ", 0, QApplication::UnicodeUTF8));
